...
?>
<?php
$titre = "Liste Des Opérations Annulées";
$active_menu = "index";
...
<html lang="en">
 <!-- START BREADCRUMB -->
               ...
               <ul class="breadcrumb">
                    ...
                    <li class="active">Liste des opérations annulées</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
									 ...
									 <h3 class="panel-title"><strong>| Liste des opérations planifiées <span style="color:red;font-weight:bold"> &nbsp; Annulées</span>&nbsp; du  :&nbsp; <span style="color:#1caf9a;font-weight:bold"><?php if ( $ord=Ordonnateur::trouve_par_id($user->id_ord)){ echo $ord->nom_ord;}else{}?> </span></strong></h3>
...
foreach($operations as $operation){
	$ordonnateur=Ordonnateur::trouve_par_id($operation->id_ord);
			if($situation_f = Situation_f::trouve_par_operation2($operation->id_op)){
				if($situation_f->etat_operation=='Annulées' ){
									...
									if(  $operation=Operation::trouve_par_id($situation_f->id_op)){
									  ...
									  ?>
                                           ...
                                           <td><?php $type_programme = Type_programme:: trouve_par_code($operation->code_type_prog); echo html_entity_decode($type_programme->nom_type_prog);  ?></td>
