...
<li class="xn-openable">
   ...
   <li class="xn-openable">
					 <a href="#"><span class="fa fa-download" style="font-size:18px"></span> <span class= "xn-text">Manuels d'utilisation </span></a>
                        <ul>
                        
                        <li >
                        <a href='doc_pdf\Guide_GSPI_Centralisé.pdf ' ><span class="fa fa-download" style="font-size:15px"> </span><span class= "xn-text"> Programme Centralisé </span></a>
                         </li>
                         <li >
                        <a href='doc_pdf\Guide_GSPI_Déconcentré.pdf' ><span class="fa fa-download" style="font-size:15px"> </span><span class= "xn-text"> Programme Déconcentré </span></a>
                         </li>
				       </ul>
        </li>					
					<?php  } ?>
					 ...
					 <a href="#"><span class="fa fa-indent" style="font-size:18px"></span> <span class= "xn-text"> Historique </span></a>
                       ...
                       <li> <a href="historique_modif.php"><span class="fa fa-list-alt" style="font-size:15px"></span>  Réevaluation/ Dévaluation </a></li>
                         ...
                         <li> <a href="historique_gelee.php"><span class="fa fa-list-alt" style="font-size:15px"></span>  Levée de gel </a></li>
						  ...
						  <li >
                        <a href='doc_pdf\Guide_GSPI_Centralisé.pdf ' ><span class="fa fa-Download" style="font-size:18px"> </span><span class= "xn-text"> Manuel d'utilisation </span></a>
                         </li>
                  ...
                  <li><a href="recap.php"><span class="fa fa-bar-chart-o" style="font-size:15px"> </span> Récapitulatif</a>        
					...
					<li >
					 <a href="liste_operation_refuse.php"><span class="fa fa-minus-circle" style="font-size:18px"></span> <span class= "xn-text">Opérations refusées </span></a>   
					  ...
					  <li >
                        <a href='doc_pdf\Guide_GSPI_Déconcentré.pdf' ><span class="fa fa-download" style="font-size:18px"> </span><span class= "xn-text"> Manuel d'utilisation </span></a>
                         </li>
  ...
  <li class="xn-openable"   >
				...
				<li><a href="recap.php"><span class="fa fa-bar-chart-o" style="font-size:15px"> </span> Récapitulatif</a></li>
					  ...
					  <li >
                        <a href='doc_pdf\Guide_GSPI_Centralisé.pdf ' ><span class="fa fa-download" style="font-size:18px"> </span><span class= "xn-text"> Manuel d'utlisation </span></a>
                         </li>
            ...
            <div class="page-content ">
               ...
               <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
				 ...
				 <!-- END SIGN OUT -->
                    ...
                    <!-- END TASKS -->
					<br>
					<h3 style  = "color:#FFFFFF;  "  > Gestion et suivi du programme d'investissements :   &nbsp <?php $sql=$bd->requete("select * from ordonnateur,personne where ordonnateur.id_ord=personne.id_ord and personne.id_ord=".$user->id_ord.""); while($row=mysqli_fetch_array($sql)){ echo  $row['nom_ord']; break;} ?></h3> 
