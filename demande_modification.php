...
//	echo "<script>alert(".$ordonnateur->id_prog.")</script>";
	...
	if (empty($errors)){
			...
			$operation->save();
 		  $msg_positif = '<p style= "font-size: 20px; ">    votre demande de modification a été envoyée   </p><br />';
		echo "<script>alert('votre demande envoyer ');window.location.replace('ajouter_operation.php?id_projet=".$_GET['id_projet']."');</script>";
		
		//echo "<script>alert('votre demande envoyer '); window.location.replace('index.php')</script>";
			//readresser_a('index.php');
...
<html lang="en">
 <!-- START BREADCRUMB -->
    ...
    <input type="checkbox" name="num_op" id="num_op" style="width:20px;height:20px;background-color:#399"  value="Numéro operation" onclick="change();"  > Numéro de l'operation
&nbsp;&nbsp;
    <input type="checkbox" name="nom_op" id="nom_op" style="width:20px;height:20px;background-color:#399"  value="Nom operation" onclick="change();"  >intitulé de l'operation
                                         ...
                                         <div class="form-group" >
											 ...
											 <div class="form-group" id='-1'>
                                               ...
                                               <div class="col-md-4 col-xs-12">                                             
                                                    <div class="input-group">
                                                        ...
                                                        <input style="color:#666" type="text" class="form-control" name="a_nom_oper" value="<?php echo $operation->libelle_op; ?>" readonly  >
                                                    </div>                                            
                                                 </div>
											 ...
											 <div class="form-group" id="-2">
                                                <label class="col-md-3 col-xs-12 control-label"> Ancien Numéro: </label>
                                               <div class="col-md-4 col-xs-12">                                             
                                                    <div class="input-group">
                                                        <span class="input-group-addon">N°</span>
                                                        <input style="color:#666" type="text" class="form-control" name ="a_numero_op" value="<?php echo $operation->num_op; ?>" readonly  >
                                                    </div>                                            
                                                 </div>
											 ...
											 <div class="form-group" id='2'>
                                                <label class="col-md-3 col-xs-12 control-label">Numéro de l'opération : </label>
                                               <div class="col-md-4 col-xs-12">                                             
                                                    <div class="input-group">
                                                        <span class="input-group-addon">N°</span>
                                ...
                                <div class="panel-footer">
								  ...
								  <button class="btn btn-primary pull-right"type = "submit" name = "submit" onclick='return verif_case_coche();'>Envoyer </button>
                                </div>
                            </div>
							 </div>
                        </form>
