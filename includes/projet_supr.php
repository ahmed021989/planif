...
class    Projet_supr {
	...
	protected static $nom_table="projet_supr";
	protected static $champs = array('id','id_projet','nom_projet','id_infra','id_ord','user','valide','date_demande','date_valide');
	public $id;
	public $id_projet;
	public $nom_projet;
	public $id_infra;
  ...
  public function nom_compler() {
	...
	public static function trouve_tous() {
  	...
  	public static function trouve_tous_id_projet($id_op) {
