...
if(!$session->is_logged_in()) {
	...
	$accestype = array('administrateur' or 'Admin_dsp' or 'Admin_ehs'or 'Admin_chu'or 'Admin_est'or 'Admin_psc' or 'admin_psd');
...
$id = $_GET['id_op'];
  ...
  $operation->user =$user->nom_compler();
	...
	if (empty($errors)){
			...
			$operation->save();
			echo "<script>alert('Réévaluation ajoutée! ');window.location.replace('ajouter_operation.php?id_projet=".$_GET['id_projet']."');</script>";
		
 		  $msg_positif = '<p style= "font-size: 20px; ">     "  "  Bien ajoutée  </p><br />';
...
?>
<?php
$titre = "Réévaluation/Dévaluation";
$active_menu = "index";
            ...
            <div class="mb-container">
                <div class="mb-middle">
                    ...
                    <div class="mb-content">
                        ...
                        <p>Appuyez sur Oui pour suprimer</p>
                    </div>
                    <div class="mb-footer">
