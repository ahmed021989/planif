                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-seccess">
                                <div class="panel-heading">                                
                                  	 <h3 class="panel-title"><strong>| Liste des opérations planifiées <span style="color:red;font-weight:bold"> &nbsp; Cloturées</span>&nbsp; du  :&nbsp; <span style="color:#1caf9a;font-weight:bold"><?php if ( $ord=Ordonnateur::trouve_par_id($ordonnateur)){ echo $ord->nom_ord;}else{}?> </span></strong></h3>
