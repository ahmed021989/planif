...
<?php	
                                  ...
                                  <?php	
									...
									while($rows=$bd->fetch_array($sql)){
										...
										if(($user->type=='Admin_psd' or $user->type=='administrateur' or $user->id_ord==$operation->id_ord) and $rows['id_prog']==42 and $rows['id_prog']==$prog){
...
//////////////////###############################################################"/////////////////	
									...
									if(($user->type=='Admin_psc' or $user->type=='administrateur' or $user->id_ord==$operation->id_ord) and $rows['id_prog']==41 and $rows['id_prog']==$prog){
									?>
                                            <tr id ="<?php echo html_entity_decode($operation->id_op); ?>">
											<td><?php echo html_entity_decode($operation->num_op); ?></td>
											<td><?php echo html_entity_decode($operation->libelle_op); ?></td>
