...
global $bd;
$ord=Ordonnateur::trouve_par_id($_GET['ord']);
echo "<center><h2>".$ord->nom_ord."</h2></center>";
?>
   ...
   <table class="table " id="table2" >
		...
		/*$projets=Projet::trouve_tous_ord($ord->id_ord);
		foreach($projets as $projet){*/
			
									if($operations=Operation::trouve_filtre_ord($ord->id_ord)){
