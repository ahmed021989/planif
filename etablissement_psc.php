...
if(!$session->is_logged_in()) {
	...
	$accestype = array('administrateur' , 'Admin_psc','ministre_SG' );
...
?>
<?php 
$titre = "Programmes sectoriels des wilayas";
$active_menu = "index";
$header = array('projet_supr');
if ($user->type =='administrateur' or 'Admin_psc' or 'ministre_SG'  ){
...
?>
                    ...
                    <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-info">
                                <div class="panel-heading">                                
									...
									<?php 
									$prog=$_GET['id'];
									if($prog=="CHU"){ echo "PROGRAMMES DES CHU"; }
									if($prog=="EHS"){ echo "PROGRAMMES DES EHS"; }
									if($prog=="EST"){ echo "PROGRAMMESS DES EST"; }
									if($prog=="MSPRH"){ echo "PROGRAMMES DES MSPRH"; }
	...
	<div class="panel-body">                                                                        
            <div class="row">
					...
					$sql_topo=$bd->requete("select * from ordonnateur where type_ord='".$_GET['id']."' ");
...
<label  id="<?php echo $row['id_ord'];  ?>" onclick="charger_programe(<?php echo  $row['id_ord'];?>)"  class="btn btn-info btn-lg btn-block active">
...
echo $row['nom_ord'];
	 ...
	 <div class="mb-footer">
					  ...
					  <center><span id="charge" style="font-size:14px">CHARGEMENT ...<img src="img/fileinput/loading.gif" width="20" height="20"/> </span></center>
                       ...
                       <!--***********************-->
					    <div class="panel-body scrollable" style="overflow-y: scroll;height:540px" id="operations">
