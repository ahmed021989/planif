...
?>
<?php 
$titre = "Liste des demandes de levée de gel";
$active_menu = "index";
$header = array('operation');
if ($user->type =='administrateur' or 'Admin_dsp' or 'Admin_ehs'or 'Admin_chu'or 'Admin_est' or 'Admin_msprh' or 'Admin_psd' or 'Admin_psc'  ){
...
?>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Liste des demandes de levée de gel</h2>
					
                </div>
                <!-- END PAGE TITLE -->
                		<?php 
			$operations = Operation_modif::trouve_tous_valide_gelee();
                    ...
                    <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title"> Liste des demandes de levée de gel </h3>
								...
								foreach($operations as $operation){
									...
									$operation0=Operation::trouve_par_id($operation->id_op);
								...
								?>
									...
									<td><span style="color:black"><?php echo html_entity_decode($operation0->num_op); ?></a></td>
										<td><span style="color:black"><?php echo html_entity_decode($operation0->libelle_op); ?></a></td>
											<td><span style="color:red"><?php if($operation->etat_operation=="Gelee"){echo html_entity_decode("Gelée");} ?></a></td>
										    <td><span style="color:blue"><?php echo $operation->date_demande; ?></span></td>
										  ...
										  <td>
										  <a href="confirme_gelee.php?id_modif=<?php echo $operation->id_modif;?>" ><button class="btn btn-info btn-rounded " style = "text-align: right;"><span>Accorder</span></button><a>
										 	  <a href="annule_gelee.php?id_modif=<?php echo $operation->id_modif;?>" ><button class="btn btn-danger btn-rounded " style = "text-align: right;"><span>Refuser</span></button><a>
