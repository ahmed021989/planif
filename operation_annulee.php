                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-seccess">
                                <div class="panel-heading">                                
                                  	 <h3 class="panel-title"><strong>| Liste des opérations planifiées <span style="color:red;font-weight:bold"> &nbsp; Annulées</span>&nbsp; du  :&nbsp; <span style="color:#1caf9a;font-weight:bold"><?php if ( $ord=Ordonnateur::trouve_par_id($ordonnateur)){ echo $ord->nom_ord;}else{}?> </span></strong></h3>
...
foreach($operations as $operation){
			...
			if($situation_f = Situation_f::trouve_par_operation2($operation->id_op)){
				$ordonnateur=Ordonnateur::trouve_par_id($operation->id_ord);
if($situation_f->etat_operation=='Annulées' and( $user->type=='administrateur' or $user->id_ord==$operation->id_ord)){
									?>
                                      <?php 
									  $APacc=0;
									if(  $operation=Operation::trouve_par_id($situation_f->id_op)){
