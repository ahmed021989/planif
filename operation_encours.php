...
?>
		...
		<?php if ( $user->type=='Admin_psc') {?>
                <div class="page-title">                    
                    <h3><span class="fa fa-folder-open"></span> Les opérations planifiées encours (Programme Sectoriel Centralisé)</h3>
					
                </div>
		<?php }else   if ( $user->type=='Admin_psd') { ?>	
				
				<div class="page-title">                    
                    <h3><span class="fa fa-folder-open"></span> Les opérations planifiées encours (Programme Sectoriel Déconcentré)</h3>
					
                </div>
				
		<?php }else if ($user->type=='administrateur' or $user->type=='ministre_SG'){?>
		     <div class="page-title">                    
                    <h2><span class="fa fa-folder-open"></span> Les opérations planifiées encours</h2>
