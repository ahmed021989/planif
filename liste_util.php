                    ...
                    <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
									...
									<li><a href="ajouter_util.php" class="fa fa-plus" data-toggle="tooltip" title="Nouveau utilisateur"></a></li>
								...
								?>
                                             <tr  style=" font-weight:bold" id="<?php echo $personne->id; ?>">
										
										<td><span class=""><?php echo html_entity_decode($personne->type); ?></a></td>
										<td><span class=""><?php echo html_entity_decode($personne->login); ?></a></td>
											<td><span class=""><?php echo html_entity_decode($personne->cpt); ?></a></td>
									
										<td ><span class="hidden-phone"><?php echo html_entity_decode($personne->nom); ?></a></td>
										...
										<td><span class=""><?php echo html_entity_decode($personne->prenom); ?></a></td>
										    ...
										    <td><span class=""><?php  $ordonnateur=Ordonnateur::trouve_par_id($personne->id_ord);  
											         echo html_entity_decode ($personne->wilaya); ?></span></td>
										  <td>
										  <a href="sauvgarde/pdf/imprimer.php?id=<?php echo $personne->id;?>" target="_blank"><button class="btn btn-info btn-rounded " style = "text-align: right;"><span class="glyphicon glyphicon-print"></span></button><a>
										   ...
										   <a href="edit_util.php?id=<?php echo $personne->id;?>" class="btn btn-warning btn-rounded btn-lg fa fa-pencil">  </a>
									 <a style="color:#ff0000;font-size:20px" onClick="delete_row('<?php echo  $personne->id;?>');" class=" btn btn-danger btn-rounded btn-lg fa fa-trash-o"></a>
