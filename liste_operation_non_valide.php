...
?>
<?php 
$titre = " Liste des nouvelles opérations";
$active_menu = "index";
...
?>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span>  Liste des nouvelles opérations </h2>
					
                </div>
                <!-- END PAGE TITLE -->
                		<?php 
			$operation = Operation::trouve_tous_valider();
                ...
                <div class="page-content-wrap">                
                    ...
                    <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <table class="table datatable table-striped">
                                        <thead>
											...
											<th>numéro de loi de finance </th>
											 <th>Ap initial</th>
								...
								if(($user->type=="Admin_psd" or $user->type=="administrateur" ) and $ordonnateur->id_prog==42 ){
								...
								?>
									...
									<td><?php  echo html_entity_decode($ordonnateur->nom_ord); ?></td>
										...
										<td ><span class=""><?php echo html_entity_decode($operation->libelle_op); ?></td>
										<td ><span class=""><?php echo html_entity_decode($operation->num_dp); ?></td>
											 <td ><span class=""><?php echo html_entity_decode($operation->ap_initial); ?></td>
											 	<td ><span class=""><?php echo html_entity_decode($operation->date_inscription); ?></td>
											<td><?php $rubrique = Rubrique:: trouve_par_code($operation-> code_rubrique); echo html_entity_decode($rubrique->nom_rubrique); ?></td>
                                             <td ><span class=""><?php echo html_entity_decode($operation->code_type_prog); ?></td>
											<td ><span class=""><?php echo html_entity_decode($operation->date_demande); ?></td>
											<td><?php echo html_entity_decode($operation->user); ?></td>
										
										  <td>
										  <a href="confirme_valide_op.php?id_op=<?php echo $operation->id_op;?>" ><button class="btn btn-info btn-rounded " style = "text-align: right;"><span>Valider</span></button><a>
										 	  <a href="annule_valide_op.php?id_op=<?php echo $operation->id_op;?>" ><button class="btn btn-danger btn-rounded " style = "text-align: right;"><span>Non</span></button><a>
								...
								if(($user->type=="Admin_psc" or $user->type=="administrateur" ) and $ordonnateur->id_prog==41 ){
