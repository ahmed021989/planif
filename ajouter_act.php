                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">                                                                        
                                           ...
                                           <div class="form-group">
                                                <label class="col-md-3 col-xs-12 control-label">Titre : </label>
									...
									?>
											...
											echo html_entity_decode($actualite->id_act); ?>">
												  ...
												  <td> <?php  if ($actualite->publier==1){ ?>
												   ...
												   <a  class="btn btn-success btn-sm"><span class="fa fa-check"></span>Affiché </a> 
												   <?php  
												   } else if ($actualite->publier==0){ ?>
													  
												   <a  class="btn btn-danger btn-sm"><span class="fa fa-times-circle"></span>Masqué</a> 
                                                ...
                                                <td style="width:170px">
												   ...
												   <?php  } ?>
												   	<a style="color:#fff;font-size:12px;" onClick="delete_row('<?php echo $actualite->id_act;?>');" class="btn btn-danger glyphicon glyphicon-trash"></a>
