...
class    Rubrique {
	...
	protected static $nom_table="rubrique";
	protected static $champs = array('id_rubrique','code_rubrique','nom_rubrique');
	public $id_rubrique;
  ...
  public function nom_compler() {
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE code_rubrique = '".$this->code_rubrique."' ";
  ...
  public static function trouve_tous_psd() {
		return self::trouve_par_sql("SELECT * FROM ".self::$nom_table." where code_rubrique!='r7' and code_rubrique!='r8'  ");
  }
  
  public static function trouve_par_id($id=0) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE id_rubrique ={$id} LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }

 public static function trouve_par_code($id=0) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE code_rubrique ='{$id}' LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
  ...
  public static function trouve_par_sql($sql="") {
	...
	*/
	...
	public function save(){
	 ...
	 return isset($this->id_rubrique)? $this->modifier() : $this->ajouter();
	}
...
$sql .= " WHERE id_rubrique =". $bd->escape_value($this->id_rubrique) ;
$bd->requete($sql);
