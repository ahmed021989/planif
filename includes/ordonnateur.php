...
class  Ordonnateur {
	...
	protected static $nom_table=" ordonnateur";
	protected static $champs = array('id_ord','num_ord','nom_ord','type_ord','wilaya','id_prog','topographie');
	public $id_ord;
	public $num_ord;
	public $nom_ord;
	public $type_ord;
  ...
  public function nom_compler() {
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE nom_ord = '".$this->nom_ord."' ";
  ...
  public static function trouve_par_id($id=0) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE id_ord ={$id} LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
  ...
  public static function trouve_par_sql($sql="") {
	...
	*/
	...
	public function save(){
	 ...
	 return isset($this->id_ord)? $this->modifier() : $this->ajouter();
	}
...
$sql .= " WHERE id_ord =". $bd->escape_value($this->id_ord) ;
$bd->requete($sql);
