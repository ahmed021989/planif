...
?>
<?php 
$titre = "Opérations clôturées en attente de validation";
$active_menu = "index";
...
?>
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span>Liste des opérations à clôturer  </h2>
                    ...
                    <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title"> Opérations clôturées   </h3>
                                ...
                                <div class="panel-body">
                                    <table  id="table0" class="table table-bordered" >
                                        <thead>
											...
											<th>N° décision de la clôture</th>
                                           <th style="width:170px !important">Validation</th>
								...
								?>
								 <?php 
									  ...
									  ?>
										...
										<td><?php echo html_entity_decode($APacc); ?></td> <!-- Montant de la cloture-->
