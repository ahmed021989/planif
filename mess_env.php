                ...
                <div class="content-frame">                                    
                    ...
                    <div class="content-frame-top">                        
                        <div class="page-title">                    
                            <h2><span class="fa fa-envelope"></span> Messagerie GSPI </h2>
                        </div>                                                                                
                        ...
                        <div class="block">
                            <div class="list-group border-bottom">
                                <a href="message.php" class="list-group-item"><span class="fa fa-inbox"></span> Boite de réception <span class="badge badge-success"></span></a>
                                 <a href="mess_env.php" class="list-group-item active"><span class="fa fa-rocket"></span> Messages envoyés</a>
                    ...
                    <div class="content-frame-body">
                        <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table id="table0" class="table datatable table-striped ">
                                        <thead>
                                            <tr>
