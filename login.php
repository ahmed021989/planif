...
<html lang="en" class="body-full-height">
    <head>        
        <!-- META SECTION -->
        <title>Direction des études et de la planification</title>            
 ...
 <h4> <div class="login-title" style="text-align: center;color: #FAF8F6;"><strong> Direction des Etudes et de la Planification </strong></div>	</h4> 		
		  ...
		  <br/>
                <div class="login-body">
					...
					<?php
						...
						?>
          <div class="login-title" style="text-align: left;color: #FFBF00;"><strong style="color: #170C50;"><center>Se connecter</strong> à votre Compte</center></div>
                ...
                <div class="login-footer">
                    <div class="">
                 <center>&copy; <?php echo date("Y")?> MSPRH DEP </center>
                    </div>
