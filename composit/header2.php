...
<li class="xn-openable">
				...
				<li><a href="infra_reception.php"><span class="fa fa-columns" style="font-size:15px"> </span> infrastructures receptionées </a></li>
					...
					<?php } ?>
                        ...
                        <li >
                        <a href='doc_pdf\Guide_GSPI_Centralisé.pdf ' ><span class="fa fa-download" style="font-size:18px"> </span><span class= "xn-text"> Guide Centralisé </span></a>
                         </li>
                         <li >
                        <a href='doc_pdf\Guide_GSPI_Déconcentré.pdf' ><span class="fa fa-download" style="font-size:18px"> </span><span class= "xn-text"> Guide Déconcentré </span></a>
                         </li>
