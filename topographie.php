                    ...
                    <!-- START DEFAULT DATATABLE -->
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title"><b>Programmes sectoriels de developpement   </b> </h3>
...
<br><br><br>	
            <div class="row">
                    ...
                    <div class="col-md-4">
                           ...
                           <div class="widget  btn btn-info btn-block active"  style="background:#0dec0d;;border:none" onclick="location.href='wilaya_topographie.php?id=PN';" >
                                
                               <br>
                                    <div class="widget-title"style="font-size:14px">&nbsp;</br>PROGRAMME NORMAL</div>
					 ...
					 <div class="col-md-4">
                           ...
                           <div class="widget  btn btn-info btn-block widget-item-icon"  style="background:#1caf9a;border:none" onclick="location.href='wilaya_topographie.php?id=PHP';" >
                              
                                    <div class="widget-title"style="font-size:14px">&nbsp;</br>PROGRAMME SPECIAL DES WILAYAS</br> HAUTS PLATEAUX</div>
					 ...
					 <div class="col-md-4">
                           ...
                           <div class="widget  btn btn-info btn-block widget-item-icon"  style="background:#FE9A2E;;border:none" onclick="location.href='wilaya_topographie.php?id=PS';" >
                               
                                
                                    <div class="widget-title"style="font-size:14px">&nbsp;</br>PROGRAMME SPECIAL DES WILAYAS</br> SUD</div>
