...
?>
								  	...
								  	$messaages=Message :: trouve_tous_id_destinataire($user);
                                       ...
                                       <form role="form" class="form-horizontal"   name="messagerie" id = "id" action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
                                           <div class="form-group">
                                               ...
                                               <div class="col-md-12 ">   <h4> <strong>   De :   <i></strong>                                       
                                                  
                                                  <span class="btn btn-default">  <strong>   
											 ...
											 <div class="form-group">
                                               ...
                                               <span >   <strong>    <?php if (isset($message->objet)){ echo html_entity_decode($message->objet); } ?> </strong> </h4></span>
											 ...
											 <div class="form-group">
                                               ...
                                               <div class="col-md-12"><h4> <strong>    Message :  </strong>                                      
                                                   ...
                                                   <span >  <strong>  <?php if (isset($message->message)){ echo html_entity_decode($message->message); } ?>  </strong></h4> </span>
    ...
    <td>téléchargé le fichier </td>
        ...
        <td><a href="doc_pdf/<?php echo ($message->lien_pdf) ?>" target="_blank"> Télécharger  <span class="fa fa-download"></span></a></td>
        </tr>
