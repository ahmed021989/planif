                            ...
                            <div class="list-group border-bottom">
                                <a href="message.php" class="list-group-item "><span class="fa fa-inbox"></span> Boite de réception <span class="badge badge-success"></span></a>
                                 <a href="mess_env.php" class="list-group-item"><span class="fa fa-rocket"></span> Messages envoyés</a>
                                  <a href="mess_supp.php" class="list-group-item active"><span class="fa fa-trash-o"></span> Corbeille <span class="badge badge-default"></span></a>                            
                            </div>                        
                        </div>
                    ...
                    <div class="content-frame-body">
                        <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title"> Messages supprimés </h3>
							...
							foreach($messaages as $message){
								...
								?>
                                    <tr  style="" id="<?php echo $message->id_mess; ?>">
									     ...
									     <td><?php echo html_entity_decode($message->date_supp_des); ?>	</td>
									</tr>
                                   <?php
								}
                                 ?>  
                               ...
                               <?php
						     	...
						     	foreach($messaages as $message){
								  ...
								  ?>
											...
											<td><span style=""><?php echo html_entity_decode($message->message); ?></td>
									        <td><span style="color:red"><?php echo html_entity_decode($message->date_supp_exp); ?>	</td>
