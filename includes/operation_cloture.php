...
class Operation_cloture {
	
	protected static $nom_table="operation_cloture";
	protected static $champs = array('id_op', 'date_cloture', 'numero_decesion');
	public $id;
	public $date_cloture;
	public $numero_decesion;
  ...
  public static function trouve_par_id($id=0) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE id_op={$id} LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
   public static function trouve_par_util($user) {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE type='{$user}' LIMIT 1");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
  
  public static function trouve_par_id11() {
    $result_array = self::trouve_par_sql("SELECT * FROM ".self::$nom_table." WHERE personne.id =personne.id_grade");
		return !empty($result_array) ? array_shift($result_array) : false;
  }
